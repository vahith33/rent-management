...
import { getRooms, updateRoom } from '@/actions/owner';
      ...
      <div className={`transition-all duration-500 ${showSuccess ? 'blur-md scale-[0.98]' : ''}`}>
        ...
        <main className="px-6 py-8 space-y-10">
          <section className="space-y-6">
            ...
            <div className="relative h-48 bg-[#F8FAFB] rounded-[32px] border-2 border-dashed border-slate-200 flex flex-col items-center justify-center gap-3 overflow-hidden group">
               <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center text-[#00685F] shadow-sm group-hover:scale-110 transition-transform">
               ...
               <div className="text-center">
                  <p className="text-[14px] font-black text-[#1A2B28]">Change room photo</p>
                  <p className="text-[11px] font-bold text-[#718096]">JPG or PNG, max 5MB</p>
               </div>
          ...
          <section className="space-y-6">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full bg-[#F8FAFB] border border-slate-100 rounded-2xl pl-12 pr-24 py-5 text-[#1A2B28] font-black text-[20px] outline-none focus:border-[#00685F]/30 transition-all"
              />
