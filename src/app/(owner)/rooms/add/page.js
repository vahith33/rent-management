    ...
    <div className="min-h-screen bg-white font-body relative">
      <div className={`transition-all duration-500 ${showSuccess ? 'blur-md scale-[0.98]' : ''}`}>
        ...
        <main className="px-2 pt-6">
          {/* ... existing sections ... */}
          {/* ROOM PHOTOS */}
          <section className="bg-[#F8FAFB] rounded-[32px] p-5 border border-slate-50 space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-1.5 h-6 bg-[#00685F] rounded-full"></div>
              <h2 className="text-[16px] font-black text-[#1A2B28]">Room Photo</h2>
            </div>
            
            <div className="relative h-48 bg-white rounded-[24px] border-2 border-dashed border-slate-200 flex flex-col items-center justify-center gap-3 overflow-hidden group">
               <div className="w-12 h-12 bg-[#EBFBF8] rounded-full flex items-center justify-center text-[#00685F] group-hover:scale-110 transition-transform">
