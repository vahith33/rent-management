      ...
      <div className={`transition-all duration-500 ${showSuccess ? 'blur-md scale-[0.98]' : ''}`}>
        ...
        <main className="px-2 ">
          ...
          <section className="bg-[#F8FAFB] rounded-[32px] p-5 border border-slate-50 space-y-5">
            ...
            <div className="flex flex-wrap gap-3">
              {[
                ...
                ...customAmenities.map((name, i) => ({ id: `custom-${i}`, name, icon: 'M12 2v20M2 12h20' }))
              ].map(amenity => (
                <button 
                  key={amenity.id} 
              ...
              {isAddingAmenity ? (
                <form onSubmit={handleAddCustomAmenity} className="flex items-center bg-white border border-[#00685F]/20 rounded-full px-3 py-1 shadow-sm animate-in fade-in zoom-in-95 duration-200">
                  <input 
                    autoFocus
                    type="text" 
                    ...
                    className="bg-transparent border-none outline-none py-2 px-2 text-[13px] font-bold text-[#1A2B28] w-28 placeholder:text-[#ADB5BD]"
                  />
                  <button type="submit" className="bg-[#00685F] text-white p-1.5 rounded-full hover:scale-110 active:scale-95 transition-all">
                ...
                <button 
                  ...
                  className="flex items-center justify-center w-11 h-11 rounded-full bg-white border border-dashed border-[#00685F]/30 text-[#00685F] hover:bg-[#EBFBF8] transition-all active:scale-90"
                >
          ...
          <section className="bg-[#F8FAFB] rounded-[32px] p-5 border border-slate-50 space-y-5">
            ...
            <label className="w-full h-56 border-2 border-dashed border-[#DEE3E8] rounded-[24px] bg-white flex flex-col items-center justify-center gap-4 group cursor-pointer hover:bg-[#EEF2F8] transition-all relative overflow-hidden">
               {previewUrl ? (
                 <>
